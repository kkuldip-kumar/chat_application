                        ...
                        <div className="flex flex-col overflow-hidden rounded-lg bg-white shadow-sm dark:bg-gray-800 dark:text-gray-100">
                                ...
                                <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div>
                                        <div className="mb-5 flex items-center justify-between gap-2">
                                            ...
                                            <Link to="/auth/forgot-password" className="inline-block text-sm font-medium text-blue-600 hover:text-blue-400 dark:text-blue-400 dark:hover:text-blue-300">Forgot Password?</Link>
                                        </div>
                                        <button
                                            type="submit"
                            ...
                            <div className="shrink-0 bg-gray-50 p-5 dark:bg-gray-900 dark:bg-opacity-50 md:px-16">
                                <p className="text-center text-sm text-gray-600 dark:text-gray-400">
                                    Don&apos;t have an account yet? <Link to="/auth/sign-up" className="font-medium text-blue-600 hover:text-blue-400 dark:text-blue-400 dark:hover:text-blue-300">Sign up here</Link>
                                </p>
                            </div>
                        </div>
                    </section>
