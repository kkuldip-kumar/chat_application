...
export const ChatInvite: React.FC = () => {
  return (
    <div className="grid h-[25vh] place-items-center">
      <div className="py-10 text-center">
        ...
        <div className="my-4">
          <h3 className="text-base font-medium">Chat Invitation</h3>
        </div>
        <div className="mb-4">
        ...
        <div className="flex items-center justify-center gap-2">
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Block</button>
